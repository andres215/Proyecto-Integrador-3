...
public class DialogoPerfilOcupacional extends JDialog implements ActionListener {
	...
	public DialogoPerfilOcupacional(Main principal) {
		...
		TitledBorder border = BorderFactory.createTitledBorder("Perfil Ocupacional");
		border.setTitleColor(Color.BLUE);
		border.setTitleFont(font);
		JPanel formulario = new JPanel();
		formulario.setBorder(border);
		formulario.setLayout(new GridLayout(1,1));
		textPerfil = new JTextArea(principal.getPerfilOcupacional());
	...
	public void editarPerfilOcupacional() {
		butGuardarPerfil.setEnabled(true);
		textPerfil.setEditable(true);
		butEditarPerfil.setEnabled(false);
	}
	
	public void guardarPerfilOcupacional() {
		principal.guardarPerfilOcupacional(textPerfil.getText());
		textPerfil.setEditable(false);
		butEditarPerfil.setEnabled(true);
		butGuardarPerfil.setEnabled(false);
	}
	
	public void eliminarPerfilOcupacional() {
		textPerfil.setText("");
		principal.guardarPerfilOcupacional("");
	}
	
	public void volver() {
		principal.cerrarDialogo(Main.VER_PERFIL_OCUPACIONAL);
	}
